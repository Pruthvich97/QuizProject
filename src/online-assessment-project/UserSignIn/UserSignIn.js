...
function UserSignIn() {
  ...
  const handleClick = (e) => {
    ...
    if (!isin) {
      ...
      setErrorPassword(
        "this passowrd is some one already used choose different password"
      );
    }
  };
    ...
    <>
      ...
      <div>
        <div className="adminSignupForm">
          <h1 className="errormsg">Please Create your Account!</h1>
        </div>
            ...
            <form>
              <div className="adminSignupFormcontainer">
                <div className="formBackGround">
                  ...
                  <h3 className="para">Please create your account here</h3>
                  <div>
        ...
        <div className="adminSignupForm"></div>
      </div>
    </>
  );
}
