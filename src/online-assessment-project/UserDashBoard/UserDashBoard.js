...
function UserDashboardFunction() {
  ...
  return (
    <div className="adminDahsBoardContainer">
      <h1 className="adminDashBoardHeadning"> UserDashBoard Function</h1>
          ...
          <div>
              ...
              <div>
                ...
                {/* {
                                        select ?
                                            ...
                                            :
                                            <div>
                                                <button style={{ width: 150, fontSize: 18 }} className="mcqbutton" onClick={(e) => userSelect(e)}>{item.adminname} </button>
                                            </div>
                                    } */}
              </div>
            ))}
            ...
            {/* <Popup trigger=
                        ...
                        >
                            <div className="popupcontainer">
                                    <div>
                                        <Link to="/language"><button style={{ width: 150, fontSize: 18 }} className="mcqbutton" onClick={(e) => click(e, "HTML")}>HTML </button></Link>
                                </div>
                            </div>
                        </Popup> */}
          </div>
